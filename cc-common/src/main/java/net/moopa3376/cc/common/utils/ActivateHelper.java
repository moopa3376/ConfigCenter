package net.moopa3376.cc.common.utils;


import net.moopa3376.cc.common.utils.string.ByteAndStringConverter;
...
/**
 * Created by Moopa on 09/04/2017.
 * blog: moopa.net
 *
 * @autuor : Moopa
 */
public class ActivateHelper {
    ...
    public static String getActivateCode(String loginname){
        ...
        try {
            ...
            byte[] bs = aesEncryptToBytes(loginname, "moopa3376");
    ...
    public static String getLoginname(String code){
        try {
            ...
            return aesDecryptByBytes(ByteAndStringConverter.transHexStringToBytes(s), "moopa3376");
        }catch (Exception e){
            logger.error(e.toString());
        }
        return null;
